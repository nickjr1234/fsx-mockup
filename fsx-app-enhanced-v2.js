            ...
            <div class="tlm-photos-section">
                ...
                <div class="tlm-photo-grid">
                    <div class="tlm-photo-item">
                        <label for="tlm-photo-1" class="tlm-photo-upload">
                            <input type="file" id="tlm-photo-1" accept="image/*" onchange="handleTLMPhoto(event, 1)">
                            <div class="tlm-photo-preview" id="tlm-photo-preview-1">
                    ...
                    <div class="tlm-photo-item">
                        <label for="tlm-photo-2" class="tlm-photo-upload">
                            <input type="file" id="tlm-photo-2" accept="image/*" onchange="handleTLMPhoto(event, 2)">
                            <div class="tlm-photo-preview" id="tlm-photo-preview-2">
                                <svg class="camera-icon" viewBox="0 0 24 24">
                                    <path d="M12 2C11.1 2 10.3 2.6 9.8 3.4L9.2 4.5H6C4.9 4.5 4 5.4 4 6.5V18.5C4 19.6 4.9 20.5 6 20.5H18C19.1 20.5 20 19.6 20 18.5V6.5C20 5.4 19.1 4.5 18 4.5H14.8L14.2 3.4C13.7 2.6 12.9 2 12 2ZM12 7C14.8 7 17 9.2 17 12C17 14.8 14.8 17 12 17C9.2 17 7 14.8 7 12C7 9.2 9.2 7 12 7ZM12 9C10.3 9 9 10.3 9 12C9 13.7 10.3 15 12 15C13.7 15 15 13.7 15 12C15 10.3 13.7 9 12 9Z"/>
                                </svg>
                    ...
                    <div class="tlm-photo-item">
                        <label for="tlm-photo-3" class="tlm-photo-upload">
                            <input type="file" id="tlm-photo-3" accept="image/*" onchange="handleTLMPhoto(event, 3)">
                            <div class="tlm-photo-preview" id="tlm-photo-preview-3">
                                <svg class="camera-icon" viewBox="0 0 24 24">
                                    <path d="M12 2C11.1 2 10.3 2.6 9.8 3.4L9.2 4.5H6C4.9 4.5 4 5.4 4 6.5V18.5C4 19.6 4.9 20.5 6 20.5H18C19.1 20.5 20 19.6 20 18.5V6.5C20 5.4 19.1 4.5 18 4.5H14.8L14.2 3.4C13.7 2.6 12.9 2 12 2ZM12 7C14.8 7 17 9.2 17 12C17 14.8 14.8 17 12 17C9.2 17 7 14.8 7 12C7 9.2 9.2 7 12 7ZM12 9C10.3 9 9 10.3 9 12C9 13.7 10.3 15 12 15C13.7 15 15 13.7 15 12C15 10.3 13.7 9 12 9Z"/>
                                </svg>
                ...
                <div class="tlm-comment-section">
                    <div class="tlm-section-subtitle">Comments</div>
                    <textarea 
                        id="tlm-comments" 
                        class="tlm-comment-textarea" 
                        placeholder="Enter any comments about the TLM installation, issues, or observations..."
                        onchange="saveTLMComments(this.value)"
                    >${tlmState.comments || ''}</textarea>
                </div>
            </div>
            ` : ''}
        </div>
...
function handleTLMPhoto(event, photoNumber) {
    ...
    const reader = new FileReader();
    reader.onload = function(e) {
        const preview = document.getElementById(`tlm-photo-preview-${photoNumber}`);
        preview.innerHTML = `<img src="${e.target.result}" alt="TLM Photo ${photoNumber}">`;
